const CACHE_NAME='sinnae6-fix-english-v1';
const ASSETS=['./sinnae6-app.html?v=fix-english','./manifest-sinnae6-app.json','./icon-sinnae6-app-192.png','./icon-sinnae6-app-512.png','./apple-touch-icon-sinnae6-app.png','./og-sinnae6-logo-only.png'];
